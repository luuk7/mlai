...
{
    public class AgentSoundFixed : AgentSoccer
    {
        ...
        public override void CollectObservations(VectorSensor sensor)
        {
            ...
            Debug.DrawRay(transform.position, forwardDirection * 2, Color.blue, 0.5f, false);

            // 12 floats
            sensor.AddObservation(GetSoundObservations());

            // 3 + 12 = 15 floats total
        }
        ...
        float[] GetSoundObservations(int maxAudibleEntities = 4, float hearingDistance = 25.0f, float minimumAudibleVelocity = 0.25f)
        {
